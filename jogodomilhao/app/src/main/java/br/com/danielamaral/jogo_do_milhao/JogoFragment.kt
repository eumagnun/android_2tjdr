...
class JogoFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val pergunta = selecionarPerguntaAleatoria()

        binding.tvPergunta.text = pergunta.texto
        binding.rbResposta1.text = pergunta.respostas[0].texto
        binding.rbResposta2.text = pergunta.respostas[1].texto
        binding.rbResposta3.text = pergunta.respostas[2].texto
    ...
    private fun validarResposta(respostaSelecionada: String): Boolean {
        ...
        Database.perguntas[0].respostas.forEach { resposta ->
            if (resposta.texto.equals(respostaSelecionada) && resposta.correta) {
    ...
    private fun selecionarPerguntaAleatoria(): Pergunta {
